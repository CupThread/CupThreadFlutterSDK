# AGENTS.md — CupThread Flutter SDK

## Repository Purpose
`CupThreadFlutterSDK` is the official Flutter & Dart SDK for [CupThread.com](https://cupthread.com) (Flutter 3.10+, Dart 3.0+).
...
## Quality Rules
1. Zero native binary dependencies — pure Dart and Flutter widgets.
2. Cross-platform support (iOS, Android, macOS, Windows, Linux, Web).
