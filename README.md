...
- **Zero native binary dependencies**: Pure Dart / Flutter widget tree that runs deterministically without platform-specific build plugins or compilation bloat.
- **Strict type consistency**: Full alignment with CupThread Public API schemas.
- **Comprehensive documentation**: DartDoc comments, clean widgets, and complete examples.
